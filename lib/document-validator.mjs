...
export class DocumentValidator {
	...
	#isIgnored(documentUri, mergedOptions, workspaceRoot) {
		...
		if (Object.hasOwn(mergedOptions, "ignores")) {
			...
			return settingsIgnores.some((pattern) =>
				DocumentValidator.#matchesIgnorePattern(relPath, pattern),
			);
		}
	...
	// files inside that directory (see AGENTS.md). This supplements minimatch
	// with directory-prefix checks so directory-style patterns behave like
	...
	static #matchesIgnorePattern(relPath, pattern) {
